...
!===================== core-shell droplet pair (single core) ====================================
       ...
       ! For a Pair Droplet
           ...
           Dis1_in = DSQRT((i-x0)**2 &
                       +(j-y0)**2 &
                       +(k-z0)**2) -rad2

           Dis2_in = DSQRT((i-x1)**2 &
                       +(j-y1)**2 &
                       +(k-z1)**2) -rad2

           IF (Dis1_in.LE.0.d0) THEN
               C = -Dis1_in/InterfaceThickness*2.d0

           ELSEIF (Dis2_in.LE.0.d0) THEN
               C = -Dis2_in/InterfaceThickness*2.d0

           ELSEIF ((Dis1_in.GT.0.d0).and.(Dis1.LE.0.d0)) THEN
               C = Dis1/InterfaceThickness*2.d0

           ELSEIF ((Dis2_in.GT.0.d0).and.(Dis2.LE.0.d0)) THEN
               C = Dis2/InterfaceThickness*2.d0

            ELSEIF ((Dis1.GT.0.d0).and.(Dis2.GT.0.d0)) THEN
              C = MIN(Dis1,Dis2)/InterfaceThickness*2.d0
...
!=======================================================================================
           ...
           IF (Walls(i,j,k) <= 0) rc0(i,j,k) = rcm-rch*DTANH(C)
